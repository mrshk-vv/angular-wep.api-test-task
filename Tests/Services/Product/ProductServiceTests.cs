    ...
    public class ProductServiceTests
    {
        ...
        public async Task AddProduct_ShouldReturnProduct_WhenInputDataIsCorrect()
        {
            ...
            _productMockRepo.Verify(x => 
                x.AddProductAsync(It.Is<Product>(p => addingProduct.Name == p.Name &&
        ...
        public async Task RemoveProduct_ShouldReturnTrue_WhenProductExist()
        {
            ...
            _productMockRepo.Setup(x => x.RemoveProductAsync(It.IsAny<Product>()))
                            .ReturnsAsync(true);
        ...
        public async Task UpdateProduct_ShouldReturnProduct_WhenProductExistAndDataForEditIsCorrect()
        {
            ...
            var productFromDb = _mapper.Map<ProductModel, Product>(editingProduct);
            ...
            _productMockRepo.Setup(x => x.UpdateProductAsync(It.IsAny<Product>()))
            ...
            _productMockRepo.Verify(x => x.UpdateProductAsync(It.Is<Product>(p => p.Id == editedProduct.Id &&
